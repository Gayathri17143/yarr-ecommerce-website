...
const TestimonialCarousel = () => {
  ...
  const isXs = useMediaQuery(theme.breakpoints.down("sm")); // below 600px
  ...
  if (isXs) slidePercentage = 100; // 1 slide
  else if (isSm) slidePercentage = 50; // 2 slides
  else if (isMdUp) slidePercentage = 33; // 3 slides
    ...
    <Container>
      <Box sx={{ padding: "20px 0px 0px 0px" }}>
        ...
        <CustomCarousel
          ...
          interval={3000}
          centerMode={true}
          centerSlidePercentage={slidePercentage} // Show 3 cards per view
              ...
              >
                <Card
                  ...
                  sx={{
                    width: isCenter
                      ? { xs: "90%", sm: 350}
                      : { xs: "85%", sm: 250 }, // Responsive card size
                      height: { xs: 200, sm: 250, md: 230 },
                ...
                >
                  ...
                  <Box
                    ...
                    alt={item.name}
                    sx={{
                      width: { xs: "15%", sm: "20%!important" },
                      height: { xs: "25%", sm: "27%" },
                      borderRadius: "50%", // Make the image circular
                      objectFit: "contain",
                      position: "absolute",
                      top: { xs: "-25px", sm: "-40px", md: "-40px" },
                      left: "50%",
                      zIndex: 2,
